        ...
        <footer className="bg-muted border-t mt-16">
            <div className="container mx-auto px-4 py-8 md:py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Navigation */}
                    <div>
                        <h4 className="font-bold font-headline mb-4">Navegación</h4>
                    ...
                    {/* Support */}
                    <div>
                        <h4 className="font-bold font-headline mb-4">Soporte</h4>
                        <ul className="space-y-2 text-sm">
                    ...
                    {/* Contact */}
                     <div>
                        <h4 className="font-bold font-headline mb-4">Contacto</h4>
                        <ul className="space-y-2 text-sm">
                            <li><a href="mailto:hola@fungigrow.cl" className="text-muted-foreground hover:text-primary">hola@fungigrow.cl</a></li>
                            <li><a href="tel:+56928207086" className="text-muted-foreground hover:text-primary">+56 9 2820 7086</a></li>
                            <li className="text-muted-foreground">Villarrica, Chile</li>
                        </ul>
                    </div>
                </div>
